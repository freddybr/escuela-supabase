...
// Ocultar acciones si el usuario es docente en ciertas vistas (se controla en la vista principal)
const icons = {
  ...
  reportes: `<svg class="header-icon-svg" viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>`,
...
const iconSvg = computed(() => icons[props.tipo] || '');
</script>

<template>
  <div class="header-seccion">
    <div class="header-seccion-main">
      <span class="header-icon" v-html="iconSvg"></span>
    ...
    <!-- Ranura para botones o acciones adicionales de la sección -->
